...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "support": (
            "{} <b>Link to</b> <a href='https://t.me/Trollubchat'>support chat</a></b>"
        ),
        "partial_load": (
        ...
        "request_join": "You requested link for TrollUB support chat",
        "core_notice": (
    ...
    strings_ru = {
        ...
        "support": (
            "{} <b>Ссылка на</b> <a href='https://t.me/trollubchat'>чат помощи</a></b>"
        ),
        ...
        "request_join": "Вы запросили ссылку на чат помощи TrollUB",
        "core_notice": (
    ...
    strings_it = {
        ...
        "support": (
            "{} <b>Link al</b> <a href='https://t.me/TrollUBchat'>chat di"
            " supporto</a></b>"
        ),
        ...
        "request_join": "Hai richiesto il link per il gruppo di supporto TrollUB",
        "core_notice": (
    ...
    strings_de = {
        ...
        "support": (
            "{} <b>Link zum</b> <a href='https://t.me/TrollUBchat'>Supportchat</a></b>"
        ),
    ...
    strings_tr = {
        ...
        "support": "{} <b><a href='https://t.me/TrollUBchat'>Destek sohbeti</a></b>",
        ...
        "request_join": "TrollUB Destek sohbetinin davet bağlantısını istediniz",
        "core_notice": (
    ...
    strings_uz = {
        ...
        "support": "{} <b><a href='https://t.me/TrollUBchat'>Yordam chat</a></b>",
    ...
    strings_es = {
        ...
        "support": "{} <b><a href='https://t.me/TrollUBchat'>Chat de soporte</a></b>",
    ...
    strings_kk = {
        ...
        "support": "{} <b><a href='https://t.me/TrollUBchat'>Көмек сөйлесу</a></b>",
    ...
    strings_tt = {
        ...
        "support": (
            "{} <b>Сылтама</b> <href='https://t.me/TrollUBchat'>ярдәм чаты</a></b>"
        ),
        ...
        "request_join": "Сез TrollUB ярдәм чатына сылтама сорадыгыз",
        "core_notice": (
    ...
    @loader.command(
        ru_doc="Показать ссылку на чат помощи TrollUB",
        it_doc="Mostra il link al gruppo di supporto TrollUB",
        de_doc="Zeige den Link zum TrollUB-Hilfe-Chat",
        tr_doc="TrollUB yardım sohbetinin bağlantısını göster",
        uz_doc="TrollUB yordam sohbatining havolasini ko'rsatish",
        es_doc="Mostrar enlace al chat de ayuda de TrollUB",
        kk_doc="TrollUB анықтама сөйлесушісінің сілтемесін көрсету",
    )
    async def support(self, message):
        """Get link of TrollUB support chat"""
        if message.out:
            await self.request_join("@TrollUBchat", self.strings("request_join"))
