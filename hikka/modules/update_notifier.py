...
class UpdateNotifierMod(loader.Module):
    """Tracks latest TrollUB releases, and notifies you, if update is required"""

    strings = {
        "name": "UpdateNotifier",
        "update_required": (
            "🌘 <b>TrollUB Update available!</b>\n\nNew TrollUB version released.\n🔮"
            " <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 And {} more...</b></i>",
    ...
    strings_ru = {
        "update_required": (
            "🌘 <b>Доступно обновление TrollUB!</b>\n\nОпубликована новая версия TrollUB.\n🔮"
            " <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 И еще {}...</b></i>",
    ...
    strings_it = {
        "update_required": (
            "🌘 <b>Aggiornamento disponibile per TrollUB!</b>\n\nÈ stato rilasciato un"
            " nuovo aggiornamento per TrollUB.\n🔮 <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 E altri {}...</b></i>",
    ...
    strings_de = {
        "update_required": (
            "🌘 <b>TrollUB Update verfügbar!</b>\n\nNeue TrollUB Version veröffentlicht.\n🔮"
            " <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Und {} mehr...</b></i>",
    ...
    strings_uz = {
        "update_required": (
            "🌘 <b>TrollUB yangilash mavjud!</b>\n\nYangi TrollUB versiyasi chiqdi.\n🔮"
            " <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Va {} boshqa...</b></i>",
    ...
    strings_tr = {
        "update_required": (
            "🌘 <b>TrollUB güncellemesi mevcut!</b>\n\nYeni bir TrollUB sürümü"
            " yayınlandı.\n🔮 <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
    ...
    strings_es = {
        "update_required": (
            "🌘 <b>¡Actualización de TrollUB disponible!</b>\n\nSe ha publicado una nueva"
            " versión de TrollUB.\n🔮 <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 Y {} más...</b></i>",
    ...
    strings_kk = {
        "update_required": (
            "🌘 <b>TrollUB жаңартуға болады!</b>\n\nЖаңа TrollUB нұсқасы жарияланды.\n🔮"
            " <b>TrollUB <s>{}</s> -> {}</b>\n\n{}"
        ),
        ...
        if self._pending not in [utils.get_git_hash(), self._notified]:
            m = await self.inline.bot.send_message(
                ...
                self.strings("update_required").format(
                    ...
                    '<a href="https://github.com/trollub/trollcompare/{}...{}">{}</a>'
                    .format(
